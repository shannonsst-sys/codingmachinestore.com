...
export default function CartIsland() {
  ...
  return <div className="cart-island">
    <button className="cart-button" type="button" onClick={() => setOpen(!open)} aria-expanded={open}><span aria-hidden="true">🛒</span> Cart <b>{count}</b></button>
