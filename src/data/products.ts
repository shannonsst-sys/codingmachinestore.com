...
export const products: Product[] = [
  {
    slug: 'dy-8', model: 'DY-8', name: 'Hand-Operated Hot Ribbon Coding Machine', type: 'Manual hot ribbon coder', category: 'ribbon-coding-machines', parentCategory: 'coding-machines', subcategory: 'ribbon', price: 40, badge: 'Entry point',
  ...
  {
    slug: 'hp-241b', model: 'HP-241B', name: 'Electric Hot Ribbon Coding Machine', type: 'Electric hot ribbon coder', category: 'ribbon-coding-machines', parentCategory: 'coding-machines', subcategory: 'ribbon', price: 160, badge: 'Best value',
