...
export const products: Product[] = [
  ...
  },
  {
    ...
    hero: '/assets/products/copper-type-characters/character-reference.png',
    gallery: ['/assets/products/copper-type-characters/character-reference.png', '/assets/products/copper-type-characters/machine-context.png'],
    detailGallery: ['/assets/products/copper-type-characters/character-reference.png', '/assets/products/copper-type-characters/machine-context.png'],
  ...
  },
  {
    ...
    hero: '/assets/products/copper-type-box/standard-english-numeric.png',
    gallery: ['/assets/products/copper-type-box/standard-english-numeric.png', '/assets/products/copper-type-box/numeric-72.png', '/assets/products/copper-type-box/english-numeric-120.png'],
    detailGallery: ['/assets/products/copper-type-box/standard-english-numeric.png', '/assets/products/copper-type-box/numeric-72.png', '/assets/products/copper-type-box/english-numeric-120.png'],
    description: 'Ready-to-use copper character boxes for ribbon coding machines, with standard English, number and custom configurations.',
    longDescription: 'Select a standard character box for common date and batch coding, or choose the customized 74-character box and send the exact letters, numbers and symbols you need. Custom configurations are limited to 74 pieces so we can check the character mix before confirming the quote.',
    applications: 'DY-8 · HP-241B · Ribbon coding machines',
    specs: [['Standard English + numbers', '74-character layout · $25'], ['Numeric box', '72-character layout · $25'], ['English + numbers', '120-character layout · $40'], ['Customized box', 'Up to 74 characters · Quote on request']],
