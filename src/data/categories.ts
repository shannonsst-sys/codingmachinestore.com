...
export const categories: Category[] = [
  ...
  { slug: 'machine-parts', label: 'MACHINE PARTS', title: 'Machine parts', description: 'Compatible ribbons, cartridges and ink rollers organized by the machine they fit.', featured: true },
