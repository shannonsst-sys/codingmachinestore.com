...
export const categories: Category[] = [
  ...
  { slug: 'machine-parts', label: 'CONSUMABLES', title: 'Consumables', description: 'Machine parts organized by the equipment they fit: ribbon, cartridge and ink roller.', featured: true },
